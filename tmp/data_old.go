...
func (cont *containerBase) MoveItem(item string, pos Vector) {
	cont.Items[item].SetPosition(pos)
}

// MoveItemToFraction moves the item to a fraction of the parent container size
func (cont *containerBase) MoveItemToFraction(item string, pos FractionVector) {
...
func (cont *containerBase) ResizeItem(item string, size Vector) {
	cont.Items[item].SetSize(size)
}

// ResizeItemToFraction resizes an Item to a fraction of the parent container size
func (cont *containerBase) ResizeItemToFraction(item string, size FractionVector) {
...
func (cont *containerBase) GetItemAt(pos Vector) Item {
